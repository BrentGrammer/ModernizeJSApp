...
var _firstscriptJs = require("./firstscript.js");
console.log({
    stuff: _firstscriptJs
}); // this is an empty object - why can't I import contents from firstscript.js?
_firstscriptJs.someGlobal.run = function() {
    return "hello from someGlobal.run in second script.";
};

},{"./firstscript.js":"1hQ3K"}]},["clG3k","l5veU"], "l5veU", "parcelRequire937d")
